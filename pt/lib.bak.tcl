...
/proj/libs/marvell/tsmc28hpm/svt/m9szd_tcd/rev3.2/synopsys \
 \
/proj/libs/marvell/tsmc28hpm/hvt/m7hzd_std/rev1.2/synopsys/ccstn/ \
...
/proj/libs/marvell/tsmc28hpm/svt/m7snd_std/rev1.2/synopsys/ccstn/ \
...
/proj/libs/marvell/tsmc28hpm/svt/m7spd_tcd/rev1.2/synopsys \
 \
/proj/deneb1/libset/Deneb.1.0A.20141020/db \
]

foreach SingleLib [list slow0p81v125 typ0p9v110 fast0p99vn40 fast0p99v125 slow0p81vn10] {

  set link_lib_ram_$SingleLib ""
  foreach iRAMIP [ls /proj/deneb1/libset/Deneb.1.0A.20141020/db/*_${SingleLib}*.db] {lappend link_lib_ram_$SingleLib $iRAMIP}

  set link_lib_std_$SingleLib [list * \
    m9lzd_std_${SingleLib}_ccstn.db m9hzd_std_${SingleLib}_ccstn.db m9szd_std_${SingleLib}_ccstn.db m9snd_std_${SingleLib}_ccstn.db \
    m9szd_misc_${SingleLib}_ccstn.db m9szd_clklib_${SingleLib}_ccstn.db m9szd_tielib_${SingleLib}.db m9szd_tcd_${SingleLib}.db m9lzd_misc_${SingleLib}_ccstn.db\
    m7lzd_std_slow0p9vn40_ccstn.db m7hzd_std_${SingleLib}_ccstn.db m7szd_std_${SingleLib}_ccstn.db m7snd_std_${SingleLib}_ccstn.db \
    m7szd_sync_${SingleLib}_ccstn.db m7szd_clklib_${SingleLib}_ccstn.db m7spd_tielib_${SingleLib}.db m7spd_tcd_${SingleLib}.db m7lzd_sync_${SingleLib}_ccstn.db\
]
